...
stripe.api_key = "sk_test_51HVFsaEWbH41VWCjZfv22GGXKtz7tWAcy6SwgbIvek5AhwjPSnMcM3qlxOx1pEHvK84A7yIrVnUkT6TjbigoxABh00lT8ai8xU"
...
def new_card_post_save_reciver(sender, instance, created, *args, **kwargs):
	if instance.default:
		billing_profile = instance.billing_profile
		qs = Card.objects.filter(billing_profile=billing_profile).exclude(pk=instance.pk)
		qs.update(default=False)

post_save.connect(new_card_post_save_reciver, sender=Card)
